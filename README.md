...
### <h2 align="center">  💫💫💫  &nbsp; [Live Demo](https://memoriesfrontend.vercel.app/posts) 💫💫💫  </h2>
...
- **Login and Logout system**
  - Every user has to log in with google accounts or create their account using their email to post the memories.
...
- **Product life cycle**
  - A user will log in into the app with their Google accounts or their existing account.
  ...
  - Any user after logging in can click on the post and see the details of the post.
...
- **Other facilities**
  ...
  -Users can click on specific posts and see the details of the post.
